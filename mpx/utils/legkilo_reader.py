...
#                 leg_kilo_base_orient.append(np.array(temp_base_orient)) # base orient
...
#                 vel_b = np.array(msg.velocity, dtype=float)
#                 pos_b = np.array(msg.position, dtype=float)
#                 leg_kilo_base_vel.append(vel_b) # base vel
#                 leg_kilo_base_pos.append(pos_b) # base pos

#                 # world frame
#                 R = quat_to_rot(temp_base_orient)
#                 vel_w = R @ vel_b
#                 leg_kilo_base_vel_w.append(np.array(vel_w, dtype=float))
...
#     # integrate base_vel_w to get base_pos_w
#     pos_w = np.zeros((3,)) # init pos
#     dt = compute_mean_dt(leg_kilo_time_state)
#     for vel_w in leg_kilo_base_vel_w:
#         pos_w = pos_w + vel_w * dt
#         leg_kilo_base_pos_w.append(pos_w)                
...
#     leg_kilo_base_vel_w = np.array(leg_kilo_base_vel_w)
#     leg_kilo_base_pos = np.array(leg_kilo_base_pos)
#     leg_kilo_base_pos_w = np.array(leg_kilo_base_pos_w)
...
#             base_vel_w=leg_kilo_base_vel_w,
#             base_pos=leg_kilo_base_pos,
#             base_pos_w=leg_kilo_base_pos_w,
...
#         print(f"Saved data in: {outpur_dir}")
...
# def read_ground_truth_txt_file():
#     pass
