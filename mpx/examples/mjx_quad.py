...
def log_values(dataset, sim_num, dt, t, qpos, qvel, qacc, tau_total, contact_states, contact_pos, contact_forces, q):
    """
        ...
        if (counter % (sim_frequency / mpc_frequency) == 0 or counter == 0):
            ...
            if counter != 0:
                for i in range(delay):
                    ...
                    log_values(custom_dataset, sim_num, dt, t, qpos, qvel, qacc, tau+tau_fb, contact_states, contact_pos, contact_forces, q) # ADDED BY ME: add values to dataset
